...
- **Мост** (`TUIBridge` в `Interface/tui_bridge.py`) — канал из фонового потока агента в UI: ответы, инструменты, Creator-дерево, стоп.
...
| `file_explorer.py` | Дерево проекта, действия с файлами, вкладка настроек (тема, размер UI, ключи). |
